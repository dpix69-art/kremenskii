...
// старые автогенерированные картинки — оставляем пока как есть
...
export default function Home() {
  ...
  // Для hash-роутера безопасно сразу ставить #/...
    ...
    <div className="min-h-screen bg-background flex flex-col">
      ...
      <main className="flex-1">
        ...
        <div style={{ marginTop: "var(--heading-gap-lg)" }}>
          <GalleryGrid items={mixedGalleryItems} columns={2} showArtworkBadge={true} />
        </div>
      </main>
